function [acc,acc_ref] = Caltech2Amazon(random_state,feature_type)
rng(random_state);
...
[y_data_target_trn,labels_target_trn,y_data_target_test,labels_target_test] = getData('amazon_10',3,feature_type);
