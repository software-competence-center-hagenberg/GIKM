function [acc,acc_ref] = Caltech2Webcam(random_state,feature_type)
rng(random_state);
min_distance_arr = cell(1,2);
labels_arr_arr = cell(1,2);
[y_data_source_trn,labels_source_trn,~,~] = getData('caltech256_10',8,feature_type);
y_data_source_trn = tanh(y_data_source_trn);
[y_data_target_trn,labels_target_trn,y_data_target_test,labels_target_test] = getData('webcam_10',3,feature_type);
