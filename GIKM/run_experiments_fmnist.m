function [] = run_experiments_fmnist()
rng(080324);
...
for k = 1:n_experiments
    [client_id_trn] = divide_data_into_non_iid_label_screw(labels_trn,n_clients,round(0.2*numel(labels)));
...
mean_local_acc_20 = mean(avg_local_acc_arr);
std_local_acc_20 = std(avg_local_acc_arr);
mean_global_acc_20 = mean(avg_global_acc_arr);
std_global_acc_20 = std(avg_global_acc_arr);
save('run_experiments_fmnist.mat','mean_local_acc_20','std_local_acc_20',...
    'mean_global_acc_20','std_global_acc_20');
fprintf('local accuracy twenty percentage = %f, std = %f.\n',mean_local_acc_20,std_local_acc_20);
fprintf('global accuracy twenty percentage = %f, std = %f.\n',mean_global_acc_20,std_global_acc_20);
return
